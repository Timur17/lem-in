...
/*   Updated: 2019/12/21 01:27:50 by bpole            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		render_menu(t_data *data)
{
	...
	mlx_string_put(data->mlx, data->win, 65, 140,
			TEXT_COLOR, "Speed - Press +/-");
	mlx_string_put(data->mlx, data->win, 65, 160,
			TEXT_COLOR, "Pause - \"P\"");
	mlx_string_put(data->mlx, data->win, 65, 180,
			TEXT_COLOR, "Reset - \"R\"");
}
